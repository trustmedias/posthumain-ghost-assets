...
(function () {
  ...
  var CSS = [
    ...
    "a.ph-srcm-btn--primary,a.ph-srcm-btn--primary:visited{background:#00ff77;color:#fff!important}",
    "a.ph-srcm-btn--primary:hover,a.ph-srcm-btn--primary:focus{background:#46ff9a;color:#fff!important}",
